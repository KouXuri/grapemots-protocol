...
| Fig. 3, §III-D | sign-crossing $r$ for four corpora; aspect ratios; share of pairs above (2) | `results/ext_cadence_0813/geometry_*.json` | `tools/thinned_geometry.py`, `tools/make_fig_geometry_and_sign.py` |
...
| §II-D, ownership gate | $e$ unchanged at ownership IoU 0.3/0.5/0.7 while coverage reads 0.41/0.35/0.25 against 0.74/0.69/0.53; no tie decides an owner at 0.5 | `results/definition_0815/definition_sensitivity.json` | `tools/definition_sensitivity_0815.py` |
